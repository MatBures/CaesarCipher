...
public class App {
    public static void main( String[] args ) {
		...
		case "E":
			...
			System.out.println(fileContent); //zobrazí v konzoli text txt dokumentu
			String encryptingMessage = encryptMessageService.encryptMessage(fileContent); //zavolá encrypting message methodu a použije ji, DULEŽITÉ !!
			break;
		...
		case "D":
			...
			System.out.println(fileContent); //zobrazí v konzoli text txt dokumentu
			encryptingMessage = decryptMessageService.decryptMessage(fileContent);  //zavolá decrypting message methodu a použije ji, DULEŽITÉ !!
			break;
        ...
        //TODO:   C:\Users\Jakub\Desktop\Caesar\MessageEnscrypt.txt 		C:\Users\Jakub\Desktop\Caesar\MessageDescrypt.txt
        /**
